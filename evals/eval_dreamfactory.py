...
import arcade_dreamfactory
from arcade_dreamfactory.tools.hello import say_hello
...
catalog = ToolCatalog()
catalog.add_module(arcade_dreamfactory)


@tool_eval()
def dreamfactory_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="dreamfactory Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to dreamfactory tools. "
